...
for day in range(n_days):
    ...
    filenname = '../results/sim_history/og_history_(' + start_date + ')_(' + str(n_days) + '_days)' + '_(price_slope_' + str(price_slope) +  ')_(regime_slope_' + str(regime_slope) +  ')_(seed_' + str(seed) +  ')_(n_s_' + str(n_s) + ')_(sys_model_' +  sys_mod + ')_(sys_true_' + sys_true + ')' +  '.npy'
