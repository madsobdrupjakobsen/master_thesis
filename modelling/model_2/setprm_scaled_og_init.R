setprm <- function(model) {
  ...
  model$setParameter( mu0 = c(init=1  ,lb=0     ,ub=1000/962.5912549) )
  
  
  model$setParameter(  omega1 = c(init=0.3629961   ,lb=1e-5  ,ub=10 ) )
  model$setParameter(  xi1 = c(init=0.4967667   ,lb=1e-5  ,ub=0.9 ) )
  model$setParameter( mu1 = c(init=1  ,lb=-0     ,ub=1000/698.1883135) )
  ...
  model$setParameter(  offset = c(init=1, lb=400/591.2794245, ub=800/591.2794245))
